...
parser.add_argument("-r", "--rotary", nargs='?', action="store_true", help="Use the encoder")
parser.add_argument("-k", "--keyboard", nargs='?', action="store_true", help="Use the keyboard")
parser.add_argument("-fr", "--french", nargs='?', action="store_true", help="French language")
parser.add_argument("-en", "--english", nargs='?', action="store_true", help="English language")
